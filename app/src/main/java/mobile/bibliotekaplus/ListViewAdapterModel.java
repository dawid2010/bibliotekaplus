...
public class ListViewAdapterModel extends BaseAdapter implements Filterable {

    Context c;
    ArrayList<Spacecraft> spacecrafts;
    public ArrayList<Spacecraft> currentList;
    FilterHelperModel filterHelper;

    public ListViewAdapterModel(Context c, ArrayList<Spacecraft> spacecrafts) {
        this.c = c;
    ...
    public Filter getFilter() {
        ...
        {
            filterHelper=new FilterHelperModel(currentList,this,c);
        }
