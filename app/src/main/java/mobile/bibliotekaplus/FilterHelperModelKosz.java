...
public class FilterHelperModelKosz  extends Filter {
    ArrayList<Spacecraft> currentList;
    ListViewAdapterModelKosz adapter;
    Context c;

    public FilterHelperModelKosz(ArrayList<Spacecraft> currentList, ListViewAdapterModelKosz adapter, Context c) {
