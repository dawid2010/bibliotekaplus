...
public class ListViewAdapterModelKosz extends BaseAdapter implements Filterable {
    private GlobalClass globalClass;
    Context c;
    ArrayList<Spacecraft> spacecrafts;
    public ArrayList<Spacecraft> currentList;
    FilterHelperModelKosz filterHelper;

    public ListViewAdapterModelKosz(Context c, ArrayList<Spacecraft> spacecrafts) {
        this.c = c;
    ...
    public Filter getFilter() {
        ...
        {
            filterHelper=new FilterHelperModelKosz(currentList,this,c);
        }
