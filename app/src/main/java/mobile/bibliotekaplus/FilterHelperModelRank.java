...
public class FilterHelperModelRank extends Filter {
    ArrayList<Spacecraft> currentList;
    ListViewAdapterModelRank adapter;
    Context c;

    public FilterHelperModelRank(ArrayList<Spacecraft> currentList, ListViewAdapterModelRank adapter, Context c) {
